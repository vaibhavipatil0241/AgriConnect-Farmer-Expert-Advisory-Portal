...
<head>
    ...
    <title>View and Respond to Farmers' Queries</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<table>
    ...
    <tr>
        ...
        <td>
            <form action="Response_to_Queries_Expert_3" method="post">
                <input type="hidden" name="query_id" value="<%= queryId %>">
                <textarea name="response_text" rows="3" placeholder="Write your response here..."></textarea><br>
